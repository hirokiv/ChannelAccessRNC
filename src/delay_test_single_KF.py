...
def load_FC_raws():
   import user_pickle as up
   time_buff = up.pickle_load('../Image_sampleT_test/time_buff.pickle')
   fc3 = up.pickle_load('../Image_sampleT_test/fc3.pickle')
   fc4 = up.pickle_load('../Image_sampleT_test/fc4.pickle')
   print(fc3)
   print(fc4)
   print(time_buff)
...
#  mg1 = PSClass(mgname, diffmax, 'dim', T) # right
  ...
  fc4 = FCClass(fcname, T, buff_mode='Single') # No averaging
  fc3 = FCClass(fcname, T, buff_mode='Single') # No averaging
...
#    mg1.show_current()
    ...
    # just submit
    if (step % 20 == 0):
      async_future1 = executor.submit(plot_functions, fc3, fc4)
      async_future2 = executor.submit(dump_functions, fc3, fc4)
